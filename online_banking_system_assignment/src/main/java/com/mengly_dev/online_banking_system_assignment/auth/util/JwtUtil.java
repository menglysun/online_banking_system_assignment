package com.mengly_dev.online_banking_system_assignment.auth.util;
...
public class JwtUtil {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) { final String username = getUsernameFromToken(token);
